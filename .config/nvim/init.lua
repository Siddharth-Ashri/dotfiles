...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- many times.
          --
          -- In this caseon we create a function that lets us more easily define mappings specific
          ...
          vim.keymap.set('i', '<C-]>', vim.lsp.buf.signature_help, { buffer = event.buf, desc = 'Signature Help' })
      ...
      -- Ensure the servers an tools above are installed
  ...
  },
  {
    ...
    config = function()
      ...
      -- display the full filename with path in gls.left[5] section
      gls.left[5] = {
        FileName = {
          separator = ' ',
          provider = function()
...
-- Keymap to switch between windows using Ctrl+h/j/k/l
